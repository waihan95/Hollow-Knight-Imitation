...
public partial class @InputControl: IInputActionCollection2, IDisposable
{
    ...
    ~@InputControl()
    {
        Debug.Assert(!m_GamePlayer.enabled, "This will cause a leak and performance issues, InputControl.GamePlayer.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputControl.UI.Disable() has not been called.");
    }
